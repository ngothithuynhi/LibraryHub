  ...
  <div class="auth-page">
    <div class="auth-card register-card">
      <div class="auth-left">
        ...
        <div>
          <h1>Hello!</h1>
          <p>Create an account and start exploring the LibraryHub collection.</p>
        </div>
      </div>

      <div class="auth-form">
        <h3>Register</h3>
        <p class="subtitle">Create a new LibraryHub user account.</p>
  ...
  methods: {
    async handleRegister() {
      ...
      try {
        ...
        this.message = "Register successfully. Please login.";
        ...
        this.isError = true;
        this.message = error.response?.data?.message || "Register failed";
      } finally {
        this.loading = false;
      }
    },
